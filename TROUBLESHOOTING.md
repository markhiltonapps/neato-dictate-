...
2. Ensure Neato Dictate is listed and enabled
...
3. Ensure Neato Dictate is listed and enabled
...
4. Clear model cache: `rm -rf ~/.cache/neato-dictate/whisper-models`
...
3. Restart Neato Dictate after installing

Neato Dictate tries clipboard methods in order: `wl-copy` (most reliable) → renderer `navigator.clipboard` → X11 fallback.
...
**macOS:**
1. Grant Screen Recording permission: System Settings → Privacy & Security → Screen Recording → enable Neato Dictate
...
3. Open an issue at https://github.com/NeatoVentures/neato-dictate/issues with:
   - OS version
