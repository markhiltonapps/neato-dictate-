...
const DEFAULT_DESKTOP_CALLBACK_URL = "https://neatodictate.com/auth/desktop-callback";
...
class GoogleCalendarOAuth {
  ...
  _getDesktopCallbackUrl() {
    return process.env.VITE_NEATODICTATE_OAUTH_CALLBACK_URL || DEFAULT_DESKTOP_CALLBACK_URL;
  }

  _getProtocol() {
    const channel = process.env.NEATODICTATE_CHANNEL || "production";
