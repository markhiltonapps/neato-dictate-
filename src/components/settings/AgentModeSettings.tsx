...
export default function AgentModeSettings() {
  ...
  const isCloudMode = isSignedIn && cloudAgentMode === "neato-dictate";
          ...
          {isSignedIn && (
            <SettingsPanel>
              <SettingsPanelRow>
                <button
                  onClick={() => {
                    if (!isCloudMode) setCloudAgentMode("neato-dictate");
                  }}
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2">
                      <span className="text-xs font-medium text-foreground">
                        {t("agentMode.settings.neato-dictateCloud")}
                      </span>
                      {isCloudMode && (
                    ...
                    <p className="text-xs text-muted-foreground/80 mt-0.5">
                      {t("agentMode.settings.neato-dictateCloudDescription")}
                    </p>
                  </div>
                  <div
