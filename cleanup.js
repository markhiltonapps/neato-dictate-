...
try {
  ...
  const userDataPath =
    process.platform === "darwin"
      ? path.join(os.homedir(), "Library", "Application Support", "neato-dictate")
      : process.platform === "win32"
      ? path.join(process.env.APPDATA || os.homedir(), "neato-dictate")
      : path.join(os.homedir(), ".config", "neato-dictate");
