...
const DBUS_SERVICE_NAME = "com.neatoventures.neatodictate.App";
const DBUS_OBJECT_PATH = "/com/neatoventures/NeatoDictate";
const DBUS_INTERFACE = "com.neatoventures.neatodictate.App";

// Per-slot gsettings paths and display names
const SLOT_CONFIG = {
  dictation: {
    path: "/org/gnome/settings-daemon/plugins/media-keys/custom-keybindings/neato-dictate/",
    name: "Neato Dictate Toggle",
  },
  agent: {
    path: "/org/gnome/settings-daemon/plugins/media-keys/custom-keybindings/neato-dictate-agent/",
    name: "Neato Dictate Agent",
  },
};
...
class GnomeShortcutManager {
  ...
  _createInterfaceClass(dbusModule) {
    class NeatoDictateInterface extends dbusModule.interface.Interface {
    ...
    NeatoDictateInterface.configureMembers({
      methods: {
