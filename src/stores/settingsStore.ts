...
export const useSettingsStore = create<SettingsState>()((set, get) => ({
  ...
  cloudTranscriptionMode: readString(
    ...
    hasStoredByokKey() ? "byok" : "neato-dictate"
  ),
  cloudReasoningMode: readString("cloudReasoningMode", "neato-dictate"),
  ...
  cloudAgentMode: readString("cloudAgentMode", "neato-dictate"),
...
export const selectIsCloudReasoningMode = (state: SettingsState) =>
  state.isSignedIn && state.cloudReasoningMode === "neato-dictate";

export const selectEffectiveReasoningProvider = (state: SettingsState) =>
  selectIsCloudReasoningMode(state) ? "neato-dictate" : state.reasoningProvider;

export const selectIsCloudAgentMode = (state: SettingsState) =>
  state.isSignedIn && state.cloudAgentMode === "neato-dictate";
