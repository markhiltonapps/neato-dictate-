...
export default function TranscriptionModelPicker({
  ...
  useEffect(() => {
    ...
    window.addEventListener("neato-dictate-models-cleared", handleModelsCleared);
    return () => window.removeEventListener("neato-dictate-models-cleared", handleModelsCleared);
