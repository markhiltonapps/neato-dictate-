  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end">
        ...
        <DropdownMenuItem
          onClick={async () => {
            const result = await window.electronAPI?.openExternal("mailto:support@neatoventures.com");
            if (!result?.success) {
              openExternal("https://mail.google.com/mail/?view=cm&to=support@neatoventures.com");
            }
          }}
        >
        ...
        <DropdownMenuItem
          onClick={() => openExternal("https://github.com/NeatoVentures/neato-dictate/issues")}
        >
