...
const DEFAULT_OPENAI_BASE = computeBaseUrl(
  [env.NEATODICTATE_OPENAI_BASE_URL as string | undefined, env.OPENAI_BASE_URL as string | undefined],
  "https://api.openai.com/v1"
);

const DEFAULT_TRANSCRIPTION_BASE = computeBaseUrl(
  [
    env.NEATODICTATE_TRANSCRIPTION_BASE_URL as string | undefined,
...
// Neato Dictate Cloud API
export const NEATODICTATE_API_URL = (env.VITE_NEATODICTATE_API_URL as string) || "";
