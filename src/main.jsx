...
const configuredChannel = (import.meta.env.VITE_NEATODICTATE_CHANNEL || inferredChannel)
  .trim()
  .toLowerCase();
...
const OAUTH_PROTOCOL = (import.meta.env.VITE_NEATODICTATE_PROTOCOL || defaultOAuthProtocol)
  .trim()
  .toLowerCase();
const OAUTH_AUTH_BRIDGE_URL = (import.meta.env.VITE_NEATODICTATE_AUTH_BRIDGE_URL || "").trim();
      ...
      <div id="oauth-container" role="status" aria-live="polite">
        <div class="auth-card">
          <div class="logo-wrapper">
            <svg class="logo" viewBox="0 0 1024 1024" width="64" height="64" aria-label="Neato Dictate">
